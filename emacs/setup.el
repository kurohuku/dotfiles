...
;; fsharp-mode
(shell-command "wget -P ~/.emacs.d/tmp/ http://downloads.sourceforge.net/project/fsharp-mode/fsharp-mode/beta%200.3/fsharp-0.3.zip")
(shell-command "mkdir ~/.emacs.d/elisp/fsharp-mode")
(shell-command "mv ~/.emacs.d/tmp/fsharp-0.3.zip ~/.emacs.d/elisp/fsharp-mode/")
(shell-command "unzip -d ~/.emacs.d/elisp/fsharp-mode/ ~/.emacs.d/elisp/fsharp-mode/fsharp-0.3.zip")
